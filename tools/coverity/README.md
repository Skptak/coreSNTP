...
compliance of coreSNTP Library using
...
[configuration file](https://github.com/FreeRTOS/coreSNTP/blob/main/tools/coverity/misra.config)
...
[MISRA.md](https://github.com/FreeRTOS/coreSNTP/blob/main/MISRA.md) file.
